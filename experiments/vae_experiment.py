...
class VAEXperiment(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx, optimizer_idx = 0):
        ...
        os.makedirs(f"{self.logger.save_dir}{self.logger.name}/version_{self.logger.version}/train_images/", exist_ok=True)

        if batch_idx%10==0:
            vutils.save_image(results[0].data,
                            f"{self.logger.save_dir}{self.logger.name}/version_{self.logger.version}/train_images/"
